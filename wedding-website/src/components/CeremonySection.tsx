    ...
    <InView as="div" threshold={0.1} triggerOnce>
      {({ inView, ref }) => (
        ...
        >
          ...
          <div className="font-dancing w-full md:w-1/2 flex items-center justify-center p-8 md:p-0">
            <div
            ...
            >
              <h2 className="font-dancing text-4xl md:text-7xl mb-10">Our Ceremony</h2>
              ...
              <p className="text-xl md:text-2xl mb-4">Volcán de San Salvador, El Salvador</p>
            </div>
          </div>
          <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-0">
            ...
            >
              <h2 className="font-dancing text-4xl md:text-7xl mb-10">Cocktail Hour</h2>
          ...
          <div
            ...
            >
              <h2 className="font-dancing text-4xl md:text-7xl mb-10">Reception</h2>
